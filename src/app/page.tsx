  ...
  return (
    <main>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-brand-purple to-brand-cyan text-white">
        ...
        <div className="adipa-hero-orb h-56 w-56 right-0 top-24 text-white" />
        <div className="relative mx-auto max-w-3xl px-4 py-20 text-center sm:px-6 lg:px-8">
          ...
          <a
            href="#postulacion"
            className="mt-8 inline-flex items-center gap-2 rounded-adipa bg-white px-6 py-3 text-sm font-semibold text-brand-purple transition hover:bg-white/90"
          >
            Quiero postularme
        ...
        <div className="mx-auto grid max-w-4xl gap-6 px-4 sm:grid-cols-2 sm:px-6 lg:px-8">
          <div className="adipa-card p-6">
            ...
            <ul className="mt-3 space-y-2 text-[15px] text-brand-navy/80">
              <li>
                Acceso gratuito a un curso asincrónico de tu elección (hasta $80.000 COP en
                adipa.co).
              </li>
              <li>
          ...
          <div className="adipa-card p-6">
            ...
            <ul className="mt-3 space-y-2 text-[15px] text-brand-navy/80">
              ...
              <li>Formato: selfie / POV / orgánico.</li>
          ...
          <div className="adipa-card flex items-start gap-4 p-6">
            ...
            <div>
              ...
              <p className="mt-2 text-[15px] leading-relaxed text-brand-navy/80">
                Una vez activado tu cupón, tienes <strong>15 días en total</strong> para completar
                el curso y enviarnos tus 2 videos. Si no llegan dentro de ese plazo, se revoca el
                acceso y no se habilitan futuras colaboraciones.
              </p>
            </div>
          </div>
        </div>
